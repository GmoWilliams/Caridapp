...
class MainViewController: UIViewController {
    ...
    override public func viewDidLoad() {
       ...
       showViewController(viewController: UINavigationController.self, storyboardId: "RegNavID")
...
extension MainViewController: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int) {
        ...
        case 0:
            // Inicio
            self.showViewController(viewController: UINavigationController.self, storyboardId: "RegNavID")
        case 1:
            // BDA-1,11
...
//        case 5:
//            // BDA-8
//            self.showViewController(viewController: UINavigationController.self, storyboardId: "DonNavID")
        default:
            break
        }
